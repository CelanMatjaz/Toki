...
public:
    ...
    virtual Handle createSampler(const SamplerConfig& config) override;
    ...
    virtual void bindTexture(Handle handle) override;
    virtual void bindSampler(Handle handle) override;
    virtual void bindUniform(Handle handle) override;
